...
from taming1.modules.losses_more.loss_util import weighted_loss
...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, emb_i, emb_j):
        ...
        similarity_matrix = F.cosine_similarity(representations.unsqueeze(1), representations.unsqueeze(0), dim=2).mean(dim=[2,3])
...
class SoftCrossEntropy(nn.Module):
    ...
    def forward(self, pred, target, weight=None, **kwargs):
        ...
        for y in range(C):
            ...
            y_loss = F.cross_entropy(pred, target_temp, reduction="none")
